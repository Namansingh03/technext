...
import { sizeLabels } from "@/src/features/company/constants/companyConstants";
    ...
    <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm p-7">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        >
          <Input
            type="email"
            placeholder="hello@techNext.com"
            {...register("companyEmail")}
          />
        </Field>

        <Field label="Website URL" icon={Globe} error={errors.website?.message}>
          <Input placeholder="https://techNext.com" {...register("website")} />
        </Field>
        ...
        >
          <Input
            placeholder="https://linkedin.com/company/techNext"
            {...register("linkedin")}
          />
        </Field>
