...
const CompanyForm = ({ companyDetails, type = "create" }: CompanyFormProps) => {
  ...
  return (
    <div className="w-5xl max-w-6xl dark:bg-neutral-900 dark:border-neutral-800 p-8 rounded-lg bg-white  ">
      {/* Page title */}
      <div className="mb-8">
        <p className="text-[11px]  font-semibold uppercase tracking-widest text-neutral-400 mb-1">
          TalentGate
        </p>
        <h1 className="text-3xl dark:text-neutral-100 font-bold text-neutral-900 tracking-tight">
          Create your company
        </h1>
        <p className="text-sm dark:text-neutral-300 text-neutral-500 mt-1">
